    ...
    <div   >
      <div className='max-w-[400px] mx-auto min-h-[600px] px-4 py-20' >
        ...
        <form onSubmit={ handleSubmit  }    >
          ...
          <button className='w-full my-2 p-3 bg-button text-btnText rounded-2xl  shadow-xl ' onClick={ handelButton }  >Sign up</button>
        </form>
        <p className='my-4 ' >Already have an account ? <Link href='/routs/Signin' className='text-accent' >Sign Up</Link> </p>
      </div>
    </div>
  )
}
