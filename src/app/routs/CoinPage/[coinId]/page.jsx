...
const params = useParams();
 const  url = `https://api.coingecko.com/api/v3/coins/${params.coinId}?tickers=false&sparkline=true`;
  ...
  return (
    <div  className='rounded-div  my-12 my-8 ' >
      ...
      <div  className='grid md:grid-cols-2 gap-8' >
        ...
        <div  className='flex justify-between py-4' >
          <div>
            <p   className='flex justify-between py-4' >24h High </p>
            {coin.market_data?.high_24h ? (<p>${coin.market_data.high_24h.usd.toLocaleString()}</p>):null}
          </div>
          <div>
            <p   className='flex justify-between py-4' >24h Low </p>
